...
: bEnableDebugging(false), bAutomaticStart(false), bBootToPause(false),
  ...
  bSkipIdle(true), bSyncGPUOnSkipIdleHack(true), bNTSC(false), bForceNTSCJ(false), bContinuousPlay(false),
...
void SConfig::SaveDisplaySettings(IniFile& ini)
{
	...
	display->Set("ContinuousPlay", bContinuousPlay);
}
...
void SConfig::LoadDisplaySettings(IniFile& ini)
{
	...
	display->Get("ContinuousPlay",       &bContinuousPlay,         false);
}
